    ...
    <>
      ...
      <div className="min-h-screen bg-white">
        ...
        <div className="relative bg-corporate-blue py-24 lg:py-32 overflow-hidden">
          <div className="absolute inset-0 opacity-10 bg-[url('https://s3.ihost.ge/site-chocheligroup-com/stock/photo-1486406146926-c627a92ad1ab.jpg')] bg-cover bg-center mix-blend-overlay"></div>
            ...
            {projects.map((project, index) => (
              ...
              >
                ...
                <div className="relative h-64 overflow-hidden">
                  ...
                  <img 
                    src={project.images?.[0] || 'https://s3.ihost.ge/site-chocheligroup-com/stock/photo-1486406146926-c627a92ad1ab.jpg'} 
                    alt={t(project.title)} 
