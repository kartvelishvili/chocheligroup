...
const sections = [
  {
    ...
    image: "https://s3.ihost.ge/site-chocheligroup-com/founder/506208349-10020878614662192-2846366780113441950-n.jpg",
    alignment: "left"
  },
  {
    id: 2,
      ...
      <div className="bg-white min-h-screen">
        ...
        <section ref={heroRef} className="relative h-screen w-full overflow-hidden">
          ...
          >
            ...
            <img 
              src="https://s3.ihost.ge/site-chocheligroup-com/founder/508418937-10043544265728960-2290390415442953318-n.jpg"
              alt="Tsezar Chocheli"
              className="w-full h-full object-cover object-top"
            />
          </motion.div>
