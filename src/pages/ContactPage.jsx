...
const ContactPage = () => {
  ...
  const d = getDesign('page_contact');
  ...
  return (
    <div className="min-h-screen relative overflow-hidden font-sans" style={{ backgroundColor: d.bg || '#f8fafc' }}>
      {/* Abstract Background Shapes */}
      <div className="absolute top-0 right-0 w-[600px] h-[600px] rounded-full blur-3xl -translate-y-1/2 translate-x-1/3" style={{ backgroundColor: `${d.accent || '#1e40af'}08` }} />
      <div className="absolute bottom-0 left-0 w-[400px] h-[400px] rounded-full blur-3xl translate-y-1/3 -translate-x-1/3" style={{ backgroundColor: `${d.accent || '#1e40af'}06` }} />

      {/* Header Section */}
      <section className="pt-12 pb-24 relative z-10 overflow-hidden" style={{ background: `linear-gradient(135deg, ${d.heroBg || '#0a1628'}, ${(d.heroBg || '#0a1628')}DD)` }}>
        <div className="absolute inset-0" style={{ background: `radial-gradient(ellipse at top right, ${d.accent || '#1e40af'}15, transparent 60%)` }} />
        <div className="absolute bottom-0 left-0 w-full h-1" style={{ background: `linear-gradient(to right, ${d.accent || '#1e40af'}, transparent)` }} />
        <div className="container mx-auto px-6 text-center relative z-10">
          <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="inline-block px-5 py-2 rounded-full text-sm font-semibold mb-6" style={{ backgroundColor: `${d.accent || '#1e40af'}15`, color: d.heroText || '#fff', border: `1px solid ${d.accent || '#1e40af'}30` }}>
          ...
          <motion.p 
            ...
            className="text-lg md:text-xl max-w-2xl mx-auto body-font"
            style={{ color: (d.heroText || '#fff') + 'AA' }}
          >
