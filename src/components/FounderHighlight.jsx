      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="backdrop-blur-md border rounded-3xl overflow-hidden max-w-6xl mx-auto" style={{ backgroundColor: d.cardBg, borderColor: d.cardBorder }}>
           <div className="grid grid-cols-1 lg:grid-cols-2">
              ...
              >
                <img
                  src={c?.image_url || "https://s3.ihost.ge/site-chocheligroup-com/images/506854830-10013410878742299-1013126184738099367-n.jpg"}
              ...
              >
                ...
                <Link to={language === 'ka' ? '/founder' : '/founder-en'}>
