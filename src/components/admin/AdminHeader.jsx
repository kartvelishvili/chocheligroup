...
const AdminHeader = ({ toggleMobileSidebar }) => {
  ...
  return (
    <header className="bg-white border-b border-slate-200 h-14 px-4 flex items-center justify-between sticky top-0 z-20 shadow-sm">
      <div className="flex items-center gap-3">
        ...
        <div className="flex items-center gap-2.5 text-slate-700">
          <div className="p-1.5 rounded-lg bg-blue-50">
            <PageIcon size={16} className="text-blue-600" />
          </div>
      ...
      <div className="flex items-center gap-2">
        <Button 
          ...
          className="hidden sm:flex items-center gap-2 text-slate-500 hover:text-blue-600 h-8 text-xs rounded-lg"
        >
